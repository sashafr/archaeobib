<?php echo head(array('bodyid'=>'ab-body')); ?>
    ...
    <TD> 
      <TABLE border=0 cellPadding=0 cellSpacing=0 width="100%">
        <TR>
          ...
          <TD align=right height="17" valign="top">&nbsp;</TD>
        </TR>
        <TBODY> 
        <TR> 
          <TD height="17" valign="top"> 
            <div align="center"> 
              <p><b><font size="3" face="Verdana, Arial, Helvetica, sans-serif">Southeast 
                Asian Archaeology Bibliographic Database</font></b></p>
            </div>
          </TD>
          <TD align=right height="17" valign="top"> 
            <TABLE border=0 cellPadding=0 cellSpacing=0>
              <TBODY> 
              <TR> 
                     <TD><A href="https://iseaarchaeology.org/se-asian-archaeological-digital-resources/" 
                  target=_self><IMG border=0 height=20 
                  src="logoff.gif" width=51></A><a href="bwo_help.htm" onClick="nlPopupHelp('11','1','1',null,'Full');return false;"><IMG 
                  border=0 height=20 src="help.gif" 
                  width=51></a></TD>
              </TR>
              </TBODY> 
            </TABLE>
              ...
              <TR align=right> 
                <TD> 
                  <TABLE border=0 cellPadding=0 cellSpacing=0>
                          <TBODY>
                            <TR> 
                              <TD class=bgon height=19 bgcolor="#31659C" width="10"><IMG height=19 
                        src="lefttoptab.gif" width=10></TD>
                              <TD class=bgon bgcolor="#31659C" width="48"> <div align="center">&nbsp;<a href="bw_home.htm" class="chen"><font color="#000000">Search</font></a>&nbsp;</div></TD>
                              <TD class=bgon height=19 bgcolor="#31659C" width="10"><IMG height=19 
                        src="righttoptab.gif" width=10></TD>
                              <TD class=bgoff height=19 bgcolor="#99CCFF" width="10"><IMG height=19 
                        src="lefttoptab.gif" width=10></TD>
                              <TD class=bgoff bgcolor="#99CCFF" width="91"><a href="bw_marked" class="chan">View 
                                Marked</a>&nbsp;</TD>
                              <TD class=bgoff height=19 bgcolor="#99CCFF" width="10"><IMG height=19 
                        src="righttoptab.gif" width=10></TD>
                            </TR>
        ...
        <TR> 
          <TD vAlign=top width="100%"> 
            <TABLE border=0 cellPadding=0 cellSpacing=0 width="100%">
              <TBODY> 
              <TR bgColor=#000000> 
                <TD height="1"><IMG height=1 src="stretch.gif" 
              width=1></TD>
              </TR>
              <TR bgColor=#9a9c9a> 
                <TD height="1"><IMG height=1 src="stretch.gif" 
