...
<form <?php echo tag_attributes($formAttributes); ?>>
    <div id="search-keywords" class="field<?php if (is_current_url(url('/'))): ?> ab-index-hide<?php endif ?>">
    ...
    <div id="search-narrow-by-fields" class="field">
        <div class="label<?php if (is_current_url(url('/'))): ?> ab-index-hide<?php endif ?>"><?php echo __('Narrow by Specific Fields'); ?></div>
        <div class="inputs">
        <?php
